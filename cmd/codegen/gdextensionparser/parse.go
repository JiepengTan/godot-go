...
func GenerateGDExtensionInterfaceAST(codeStr, projectPath, astOutputFilename string) (clang.CHeaderFileAST, error) {
	return generateGDExtensionInterfaceAST(codeStr, projectPath, astOutputFilename)
}
